<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Index.Master" AutoEventWireup="true" CodeBehind="FindOrganizationForm.aspx.cs" Inherits="OBDSystemAPP.UI.FindOrganizationForm" %>
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <asp:Button runat="server" ID="SearchOrganizationButton" ClientIDMode="Static" CssClass="btn btn-primary col-sm-5" Text="Search"  />
                                                <div class="col-sm-2"></div>
                                                <asp:Button runat="server" ID="resetButton" ClientIDMode="Static" Text="Reset" CssClass="btn btn-info col-sm-5"  />
                                            </div>
                                        </div>
