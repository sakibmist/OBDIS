<%@ Page Title="" Language="C#" MasterPageFile="~/ap/UI/DashBoardForm.Master" AutoEventWireup="true" CodeBehind="BldOrganizationDetailInfo.aspx.cs" Inherits="OBDSystemAPP.ap.UI.BldOrganizationDetailInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="DashboardMasterBody" runat="server">
    <div class="col-md-12" id="pagePosition">
        <div class="panel panel-primary">
            <div class="panel-heading "><span class="glyphicon glyphicon-paperclip"></span>All Blood Organization Information</div>
            <div class="panel-body">
                <asp:Label ID="InfoMessageLabel" runat="server" Text=" " Visible="False" CssClass="control-label" ClientIDMode="Static "></asp:Label>
                <div class="col-md-12">
                    <asp:GridView ID="BldOrganizationInfoGridView" ShowHeaderWhenEmpty="True" CssClass="table table-bordered table-responsive " AutoGenerateColumns="False" runat="server" ForeColor="#333333" GridLines="None">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:HyperLink runat="server" ID="deleteCheck" NavigateUrl='<%#String.Format("BldOrganizationInfo.aspx?delete=1&Id={0}",Eval("BldOrganizationInfoId")) %>'>Delete</asp:HyperLink>||<asp:HyperLink runat="server">Edit</asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
